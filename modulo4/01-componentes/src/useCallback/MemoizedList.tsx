...
const INITIAL_TASKS: Task[] = [
  { id: 1, title: 'Interfaz',    text: 'Diseñar la interfaz',    completed: false },
  { id: 2, title: 'Hooks',  text: 'Implementar los hooks',  completed: true  },
  { id: 3, title: 'Tests',     text: 'Escribir los tests',     completed: false },
  { id: 4, title: 'Accesibilidad',  text: 'Revisar accesibilidad',  completed: false },
  { id: 5, title: 'Deploy',   text: 'Deploy en producción',   completed: false },
]
